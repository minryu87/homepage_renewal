  ...
  const problemSolutions = [
    {
      ...
      process: [
        "AI 의료법 전문가 검토 - 머신러닝 기반 의료광고법 자동 검토 시스템",
        "AI 리스크 자동 감지 - 자연어 처리 기반 의료법 위반 가능성 사전 차단",
        "AI 안전한 표현 가이드 - 머신러닝 기반 민감 콘텐츠 자동 검토 시스템",
        "AI 지속적 법규 업데이트 - 실시간 의료법 변경사항 자동 반영 시스템"
      ],
      results: [
        "의료법 위반 리스크 99% 차단",
    ...
    },
    {
      ...
      process: [
        "AI 지역 특화 전략 - 머신러닝 기반 3km 내 환자 타겟팅 최적화",
        "AI 속성 브랜딩 - 개원 3개월 내 AI 기반 온라인 인지도 구축",
        "AI 런칭 캠페인 - 머신러닝 기반 통합 노출 전략 최적화",
        "AI 초기 평판 구축 - 자연어 처리 기반 긍정 후기 자동 관리"
      ],
      results: [
    ...
    },
    {
      ...
      process: [
        "AI SEO 진단 - 머신러닝 기반 검색엔진 최적화 상태 분석",
        "AI 기술적 SEO 개선 - 사이트 속도, 구조, 메타태그 AI 최적화",
        "AI 의료 키워드 전략 - 자연어 처리 기반 핵심 키워드 자동 분석",
        "AI 로컬 SEO 강화 - 머신러닝 기반 지역 검색 상위 노출 최적화",
        "AI 지속적 모니터링 - 실시간 검색 순위 추적 및 알고리즘 예측 대응"
      ],
      results: [
    ...
    },
    {
      ...
      process: [
        "AI 효율적 협업 시스템 - 의료진은 5분 검토만, AI가 나머지 자동 처리",
        "AI 콘텐츠 자동화 생산 - 머신러닝 기반 월 30개 콘텐츠 자동 제작",
        "AI 비용 최적화 - 개별 제작 대비 70% 비용 절감된 AI 패키지 서비스",
        "AI 품질 보장 - 의료진 감수 + AI 의료법 검토 + AI SEO 최적화 원스톱"
      ],
      results: [
        "콘텐츠 제작 시간 95% 단축",
        "콘텐츠 제작 비용 70% 절감",
    ...
    },
    {
      ...
      process: [
        "AI 실시간 모니터링 - 모든 플랫폼의 리뷰를 AI가 통합 관리",
        "AI 자동 알림 시스템 - 새 리뷰 등록 즉시 AI 분석 및 알림",
        "AI 리뷰 부스팅 - 머신러닝 기반 만족도 예측 및 리뷰 유도",
        "AI 전문 대응 가이드 - 자연어 처리 기반 의료법 준수 응답 자동 생성",
        "AI VOC 분석 - 머신러닝 기반 환자 불만 패턴 분석 및 개선점 도출"
      ],
      results: [
        "긍정 리뷰 300% 증가",
        "평균 평점 4.8점 달성 및 유지",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              머신러닝과 빅데이터 분석을 활용하여 귀하의 병원이 겪고 있는 문제를 
              기술적으로 정확히 해결해드립니다.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
                종합 솔루션: "AI 기반 All-in-One 병원 마케팅 패키지"
              </h2>
              <p className="text-xl text-blue-100">
                머신러닝과 빅데이터 분석으로 모든 문제를 한 번에 해결하고 싶다면?
              </p>
            </div>
